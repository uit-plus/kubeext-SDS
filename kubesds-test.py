...
uraid1 = parser.parse_args(["createPool", "--type", "uraid", "--pool", "pooldev", "--url", "uus-dev-independent://admin:admin@192.168.3.10:7000/p1/4/2/0/32/0/3"])
uraid2 = parser.parse_args(["createDisk", "--type", "uraid", "--pool", "pooldev", "--vol", "diskdev", "--capacity", "1073741824"])
# uraid3 = parser.parse_args(["resizeDisk", "--type", "uus", "--pool", "pooldev", "--vol", "diskdev", "--capacity", "2147483648"])
# uraid4 = parser.parse_args(["cloneDisk", "--type", "uus", "--pool", "pooldev", "--vol", "diskdev", "--newname", "diskdevclone"])
uraid5 = parser.parse_args(["deleteDisk", "--type", "uraid", "--pool", "pooldev", "--vol", "diskdev"])
uraid6 = parser.parse_args(["deletePool", "--type", "uraid", "--pool", "pooldev"])
