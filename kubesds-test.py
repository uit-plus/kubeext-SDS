...
nfs5 = parser.parse_args(["revertExternalSnapshot", "--type", "nfs", "--pool", "poolnfs", "--vol", "disknfs", "--name", "disknfs.1", "--format", "qcow2", "--backing_file", "/var/lib/libvirt/cstor/poolnfs/poolnfs/disknfs/snapshots/disknfs"])
...
gfs7 = parser.parse_args(["deleteExternalSnapshot", "--type", "glusterfs", "--pool", "poolglusterfs", "--vol", "diskglusterfs", "--name", "diskglusterfs", "--backing_file", "/var/lib/libvirt/cstor/poolglusterfs/poolglusterfs/diskglusterfs/diskglusterfs"])
