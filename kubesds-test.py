...
def check_virsh_disk_exist(pool, diskname):
    try:
        ...
        logger.debug(traceback.format_exc())
        print {"result": {"code": 208, "msg": "cant get virsh disk info, please check pool and disk is match or not"},
               "data": {}}
        exit(6)
...
uraid1 = parser.parse_args(["createPool", "--type", "dir", "--pool", "pooluraid", "--url", "uraid:///dev/md_d179:/mnt/usb/local", "--content", "vmd"])
uraid2 = parser.parse_args(["createDisk", "--type", "dir", "--pool", "pooluraid", "--vol", "diskuraid", "--capacity", "1073741824", "--format", "qcow2"])
uraid3 = parser.parse_args(["createExternalSnapshot", "--type", "dir", "--pool", "pooluraid", "--vol", "diskuraid", "--name", "diskuraid.1", "--format", "qcow2"])
uraid4 = parser.parse_args(["createExternalSnapshot", "--type", "dir", "--pool", "pooluraid", "--vol", "diskuraid", "--name", "diskuraid.2", "--format", "qcow2"])
uraid5 = parser.parse_args(["revertExternalSnapshot", "--type", "dir", "--pool", "pooluraid", "--vol", "diskuraid", "--name", "diskuraid.1", "--format", "qcow2", "--backing_file", "/pool/pooldir/diskuraid/diskuraid"])
uraid6 = parser.parse_args(["createExternalSnapshot", "--type", "dir", "--pool", "pooluraid", "--vol", "diskuraid", "--name", "diskuraid.3", "--format", "qcow2"])
uraid7 = parser.parse_args(["deleteExternalSnapshot", "--type", "dir", "--pool", "pooluraid", "--vol", "diskuraid", "--name", "diskuraid.1", "--backing_file", "/pool/pooldir/diskuraid/diskuraid"])
uraid8 = parser.parse_args(["resizeDisk", "--type", "dir", "--pool", "pooluraid", "--vol", "diskuraid", "--capacity", "2147483648"])
uraid9 = parser.parse_args(["cloneDisk", "--type", "dir", "--pool", "pooluraid", "--vol", "diskuraid", "--newname", "diskuraidclone", "--format", "qcow2"])
uraid10 = parser.parse_args(["deleteDisk", "--type", "dir", "--pool", "pooluraid", "--vol", "diskuraidclone"])
uraid11 = parser.parse_args(["deleteDisk", "--type", "dir", "--pool", "pooluraid", "--vol", "diskuraid"])
uraid12 = parser.parse_args(["stopPool", "--type", "dir", "--pool", "pooluraid"])
uraid13 = parser.parse_args(["deletePool", "--type", "dir", "--pool", "pooluraid"])
...
nfs5 = parser.parse_args(["revertExternalSnapshot", "--type", "nfs", "--pool", "poolnfs", "--vol", "disknfs", "--name", "disknfs.1", "--format", "qcow2", "--backing_file", "/var/lib/libvirt/cstor/poolnfs/poolnfs/disknfs/disknfs"])
nfs6 = parser.parse_args(["createExternalSnapshot", "--type", "nfs", "--pool", "poolnfs", "--vol", "disknfs", "--name", "disknfs.3", "--format", "qcow2"])
nfs7 = parser.parse_args(["deleteExternalSnapshot", "--type", "nfs", "--pool", "poolnfs", "--vol", "disknfs", "--name", "disknfs.1", "--backing_file", "/var/lib/libvirt/cstor/poolnfs/poolnfs/disknfs/disknfs"])
...
test_args.append(uraid1)
test_args.append(uraid2)
test_args.append(uraid3)
test_args.append(uraid4)
test_args.append(uraid5)
test_args.append(uraid6)
test_args.append(uraid7)
test_args.append(uraid8)
test_args.append(uraid9)
test_args.append(uraid10)
test_args.append(uraid11)
test_args.append(uraid12)
test_args.append(uraid13)
